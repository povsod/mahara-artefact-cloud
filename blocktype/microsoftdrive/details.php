...
$data = array();
if ($type == 'folder') {
    $data = PluginBlocktypeMicrosoftdrive::get_folder_info($id, $owner);
} else {
    $data = PluginBlocktypeMicrosoftdrive::get_file_info($id, $owner);
}
...
$smarty->display('blocktype:microsoftdrive:details.tpl');
