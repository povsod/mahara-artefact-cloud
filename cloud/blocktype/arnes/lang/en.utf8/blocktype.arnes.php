...
$string['title'] = 'File(s) from Arnes';
$string['description'] = 'Select files from Arnes space';

$string['service'] = 'Arnes'; // Same as plugin folder name, but can be CamelCase, e.g.: SkyDrive
$string['servicename'] = 'Arnes'; // Full service name, e.g.: WIndows Live SkyDrive
...
$string['applicationdesc'] = 'You must create %san application%s, if you wish to access and use Arnes API.';
