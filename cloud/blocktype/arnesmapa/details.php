...
$data = array();
if ($type == 'folder') {
    $data = PluginBlocktypeArnesmapa::get_folder_info($id, $ownerid);
} else {
    $data = PluginBlocktypeArnesmapa::get_file_info($id, $ownerid);
}
...
$smarty->display('blocktype:arnesmapa:details.tpl');
