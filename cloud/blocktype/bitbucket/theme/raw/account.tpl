...
<table style="float:right">
 <tbody>
  <tr><td><a href="{$account.user_profile}" target="_blank"><span style="font-size:x-large;font-weight:900">{$account.repositories}</span><br>{str tag=repositories section=blocktype.cloud/bitbucket}</a><br><br></td></tr>
  <tr><td><a href="{$account.user_profile}" target="_blank"><span style="font-size:x-large;font-weight:900">{$account.following}</span><br>{str tag=following section=blocktype.cloud/bitbucket}</a><br><br></td></tr>
  <tr><td><a href="{$account.user_profile}" target="_blank"><span style="font-size:x-large;font-weight:900">{$account.followers}</span><br>{str tag=followers section=blocktype.cloud/bitbucket}</a><br><br></td></tr>
 </tbody>
</table>
