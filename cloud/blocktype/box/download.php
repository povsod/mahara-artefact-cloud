...
if ($save) {
    ...
    $saveform = pieform(array(
        ...
        'elements'   => array(
            ...
            'submit' => array(
                ...
                'goto' => get_config('wwwroot') . 'artefact/cloud/blocktype/box/manage.php',
            )
        ),
    ));
    ...
    // Download file
    $file = PluginBlocktypeBox::get_file_info($id);
    $content = PluginBlocktypeBox::download_file($id);
...
function saveform_submit(Pieform $form, $values) {
    ...
    $file = PluginBlocktypeBox::get_file_info($values['fileid']);
    ...
    $content = PluginBlocktypeBox::download_file($file['id']); 
