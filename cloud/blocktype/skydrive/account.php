...
define('TITLE', get_string('servicename', 'blocktype.cloud/skydrive'));
...
switch ($action) {
    case 'login':
        PluginBlocktypeSkydrive::request_token();
        break;
    case 'logout':
        PluginBlocktypeSkydrive::delete_token();
        PluginBlocktypeSkydrive::revoke_access();
        ...
        break;
    default:
        $account = PluginBlocktypeSkydrive::account_info();
        $smarty = smarty();
