...
define('TITLE', get_string('servicename', 'blocktype.cloud/soundcloud'));
...
switch ($action) {
    case 'login':
        PluginBlocktypeSoundcloud::request_token();
        break;
    case 'logout':
        PluginBlocktypeSoundcloud::revoke_access();
        PluginBlocktypeSoundcloud::delete_token();
        redirect(get_config('wwwroot').'artefact/cloud');
        break;
    default:
        $account = PluginBlocktypeSoundcloud::account_info();
        $smarty = smarty();
