 ...
 */
function pieform_renderer_datatables(Pieform $form, $element) {
...
function pieform_renderer_datatables_header() {
    return "<table width=\"100%\" cellspacing=\"0\" border=\"0\" class=\"datatables\"><tbody>\n";
}

function pieform_renderer_datatables_footer() {
    return "</tbody></table>\n";
}
...
function pieform_renderer_datatables_get_js($id) {
    $result = <<<EOF
