...
/*
//$string['confirmdelete.album'] = 'Do you really want to delete this album? It cannot be undone.';
$string['confirmdeletefile'] = 'Do you really want to delete this file? It cannot be undone.';
$string['confirmdeletefolder'] = 'Do you really want to delete this folder? It cannot be undone.';

//$string['deletealbum'] = 'Delete album';
//$string['editalbum'] = 'Edit album';
//$string['sharealbum'] = 'Share album';
$string['deletefile'] = 'Delete file';
$string['editfile'] = 'Edit file';
$string['sharefile'] = 'Share file';
